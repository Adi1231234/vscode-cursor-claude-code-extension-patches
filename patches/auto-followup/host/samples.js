...
globalThis.__ccAfSamples = globalThis.__ccAfSamples || [
  {
    ...
    text: [
      ...
      "",
      "BEFORE ANY OTHER RULE. If nothing in this session has established how large",
      "the real input is and how many seconds a person actually waits for it, that",
      "is the question, whatever else the message contains. Optimising a number",
      "nobody waits for is the most expensive mistake available here, and it does",
      "not announce itself - the measurement looks fine, it is just of the wrong",
      "thing. Ask it once, plainly; if it is answered, never ask it again. Only when",
      "that number exists do the rules below apply.",
      "",
